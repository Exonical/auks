...
fn main() {
    ...
    let mut builder = bindgen::Builder::default()
        ...
        .allowlist_var(
            "(ADDRTYPE_INET|KRB5_AUTH_CONTEXT_.*|AP_OPTS_.*|KDC_OPT_.*|KDC_TKT_COMMON_MASK|KRB5_TC_.*|KRB5_NT_.*|KRB5_GC_.*|KRB5_FCC_NOFILE|KRB5_CC_.*|KRB5KRB_.*|KRB5_RC_.*|KRB5_NO_TKT_SUPPLIED|KRB5_TGS_NAME.*)",
        )
        .derive_default(true)
        .derive_debug(true)
